                        ...
                        <div class="pad-left20">
                            <div class="product-set">
                                <div class="product-rate clearfix">
                                    ...
                                    <h5><?php echo $tag; ?></h5>
                                    <?php if($description){ ?>
                                    <div class="des" style="max-height: 60px;margin-top: 10px;overflow: hidden;text-align: justify;position: relative;">
                                        <?php echo $description; ?>
                                        <?php if(strlen(preg_replace('#</*[a-zA-z]*>#','',$description)) >= 240){ ?>
                                ...
                                <div class="product-inputs">
                                    <form class="clearfix">
                                                        ...
                                                        <td>
                                                            <label style="margin-left: 10px;">
                                                                ...
                                                                <span class="strike-through"><?php 
                                                                    ...
                                                                    $per_special = round((preg_replace('/^[^0-9]+/','',$price))/(preg_replace('/^[^0-9]+/','',$special)),2);
                                                                echo preg_replace('/[0-9]+.[0-9]+/',preg_replace('/^[^0-9]+/','',$special)+(round(preg_replace('/^[^0-9]+/','',$option_value['price'])/$per_special,2)),$option_value['price']);
                                        ...
                                        <div class="input-append pull-right">
                                            ...
                                            <?php } ?>
                                            <label class="delivery-time"><?php echo $text_delivery_days; ?></label>
                                        </div>
                                    </form>
                                    <!--end form--> 
