...
$this->data['child_cat']=array();
                ...
                $this->data['categories'][$result['category_id']] = array('name' => $result['name'] . ($this->config->get('config_product_count') ? ' (' . $product_total . ')' : ''), 'href' => $this->url->link('product/category', 'path=' . $fstCatKey . '_' . $result['category_id'] . $url));
            }
...
$this->data['child_cat']=array();
            ...
            foreach ($limits as $limits) {
                $this->data['limits'][] = array('text' => $limits, 'value' => $limits, 'href' => $this->url->link('product/category', 'path=' . $this->request->get['path'] . $url . '&limit=' . $limits));
            }
