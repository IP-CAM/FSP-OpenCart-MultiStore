  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table id="module" class="list">
        ...
        <?php 
          if(isset($module['banner_store'])) 
          { 
            $banner_store=$module['banner_store'];
          }
          else
          {
            $banner_store=array();
            ...
            <td class="left"><input type="text" name="banner_module[<?php echo $module_row; ?>][width]" value="<?php echo $module['width']; ?>" size="3" />
              ...
              <td><div class="scrollbox">
                  ...
                  <div class="<?php echo $class; ?>">
                    ...
                    <input type="checkbox" name="banner_module[<?php echo $module_row; ?>][banner_store][]" value="0" checked="checked" />
                    <?php echo $text_default; ?>
                    <?php } else { ?>
                    <input type="checkbox" name="banner_module[<?php echo $module_row; ?>][banner_store][]" value="0" />
                    <?php echo $text_default; ?>
                    <?php } ?>
                  </div>
                  ...
                  <div class="<?php echo $class; ?>">
                    ...
                    <input type="checkbox" name="banner_module[<?php echo $module_row; ?>][banner_store][]" value="<?php echo $store['store_id']; ?>" checked="checked" />
                    <?php echo $store['name']; ?>
                    <?php } else { ?>
                    <input type="checkbox" name="banner_module[<?php echo $module_row; ?>][banner_store][]" value="<?php echo $store['store_id']; ?>" />
                    <?php echo $store['name']; ?>
                    <?php } ?>
                  </div>
                  <?php } ?>
...
function addModule() {	
	...
	html += '    </select></td>';
	html += '<td><div class="scrollbox"><?php $class = "even"; ?><div class="<?php echo $class; ?>"><input type="checkbox" name="banner_module['+module_row+'][banner_store][]" value="0" /><?php echo $text_default; ?></div><?php foreach ($stores as $store) { ?><?php $class = ($class == "even" ? "odd" : "even"); ?><div class="<?php echo $class; ?>"><input type="checkbox" name="banner_module['+module_row+'][banner_store][]" value="<?php echo $store["store_id"]; ?>" /><?php echo $store["name"]; ?></div><?php } ?></div></td>';	 
