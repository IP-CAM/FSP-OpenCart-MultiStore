    ...
    <div class="box">
        <div class="heading">
            ...
            <div class="buttons">
                ...
                <a onclick="$('#form').attr('action', '<?php echo $print_labels; ?>');
                        $('#form').attr('target', '_blank');
                        $('#form').submit();" class="button" style="target-new: tab;">
                    <span>Print Labels</span>
                </a>
                <a onclick="$('#form').attr('action', '<?php echo $export_select; ?>');
                ...
                <table class="list">
                    ...
                    <tbody>
                        <tr class="filter">
                            ...
                            <td><a onclick="$('#form').attr('action', '<?php echo $update_status; ?>');
                        $('#form').attr('target', '_self');
                        $('#form').submit();" class="button"><span>Update</span></a></td>
