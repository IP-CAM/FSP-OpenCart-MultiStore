        ...
        <table class="form">
          <tr>
            ...
            <td><select name="order_status_id" id="order_status_id" onchange="$('textarea[name=\'comment\']').val(comment_text[this.options[this.selectedIndex].value]);">
                ...
                <option value="<?php echo $order_statuses['order_status_id']; ?>" <?php if($order_statuses['order_status_id'] == $order_status){ echo 'selected="selected"'; } ?> ><?php echo $order_statuses['name']; ?></option>
                <?php } ?>
              </select></td>
          </tr>
          <tr>
