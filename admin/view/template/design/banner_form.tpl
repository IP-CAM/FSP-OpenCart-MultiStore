      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
              <td>Type</td>
              <td>
                <input type="radio" name="bannerType" value="html" <?php if ($bannerType=='html' || $bannerType=='') { ?>checked="checked"<?php } ?>/>
                HTML
                <input type="radio" name="bannerType" value="image"  <?php if ($bannerType=='image') { ?>checked="checked"<?php } ?>/>
                Image
              </td>
          </tr>
          <tr>
              ...
              <td>
                <input type="radio" name="bannerStyle" value="1" <?php if ($bannerStyle=='1') { ?>checked="checked"<?php } ?>/>
                Yes
                <input type="radio" name="bannerStyle" value="0"  <?php if ($bannerStyle=='0') { ?>checked="checked"<?php } ?>/>
                No
              </td>
         </tr>
        </table>
          ...
          <tbody id="image-row<?php echo $image_row; ?>">
            <tr>
              <td class="left"><?php foreach ($languages as $language) { ?>
                ...
                <?php } ?>
                <?php } ?></td>
             <!-- <td class="left"><input type="text" name="banner_image[<?php echo $image_row; ?>][link]" id="banner_image<?php echo $image_row; ?>" value="<?php echo $banner_image['link']; ?>" /></td>-->
              ...
              <td class="left"><textarea name="banner_image[<?php echo $image_row; ?>][bannerHTML]" id="banner_html<?php echo $image_row; ?>"><?php echo $banner_image['bannerHTML']; ?></textarea></td>
...
<?php $image_row2 = 0; ?>
<?php foreach ($banner_images as $banner_image) { ?>
CKEDITOR.replace('banner_html<?php echo $image_row2; ?>', {
...
function addImage() {
	...
	html+='<td class="left"><textarea name="banner_image['+image_row+'][bannerHTML]" id="banner_html'+image_row+'"></textarea></td>';
...
<script type="text/javascript"><!--
function addEditor(rowID)
{
    CKEDITOR.replace('banner_html'+rowID, {
	filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
