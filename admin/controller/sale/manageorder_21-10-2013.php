    ...
    public function printlabels() {
        if (isset($this->request->post['selected']) && !empty($this->request->post['selected'])) {
            ...
            foreach ($this->request->post['selected'] as $order_id) {
                ...
                $pdf->MultiCell(70, 50, $txt, 0, 'J', false, 1, 6, 15, true, 0, false, true, 0, 'T', false);

                $pdf->SetFont('arialb', 'B', 8);
                $txt = "ParcelPlus\n";
                $pdf->MultiCell(70, 50, $txt, 0, 'J', false, 1, 82, 15, true, 0, true, true, 0, 'T', false);
...
//                        . $orderinfo['telephone'];
                ...
                $pdf->MultiCell('', '', $txt, 0, 'J', false, 1, 16, 22, true, 0, true, true, 0, 'T', false);
                $pdf->SetY(15);
...
//                    'vpadding' => 'auto',
                ...
                // EAN 8
                $pdf->write1DBarcode($order_id, 'EAN8', 10, 45, 60, 18, 0.4, $style, 'N');
            }
