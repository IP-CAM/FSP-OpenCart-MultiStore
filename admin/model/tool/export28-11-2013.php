    ...
    function storeProductsIntoDatabase(&$database, &$products) {
        ...
        foreach ($products as $product) {
            ...
            if ($product['language_id'] == 1) {
                ...
                $sql .= "`stock_status_id`,`model`,`manufacturer_id`,`image`,`shipping`,`price`,`purchase_price`,`points`,`date_added`,`date_modified`,`date_available`,`weight`,`weight_class_id`,`status`,";
