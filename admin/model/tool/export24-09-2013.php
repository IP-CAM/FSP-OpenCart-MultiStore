    ...
    function storeProductsIntoDatabase(&$database, &$products) {
        ...
        foreach ($products as $product) {
            ...
            if ($product['language_id'] == 1) {
                ...
                $sql2 = "INSERT INTO `" . DB_PREFIX . "product_description` (`product_id`,`language_id`,`name`,`description`,`meta_description`,`meta_keyword`,`meta_title`,`tag`) VALUES ";
                $sql2 .= "($productId,$languageId,'$productName','$productDescription','$meta_description','$meta_keywords','$meta_title','$tags');";
                $database->query($sql);
                $database->query($sql2);
...
//            }
    ...
    protected function expectedCategoriesHeading() {
        return array("category_id", "parent_id", "name", "top", "columns", "sort_order", "image_name", "date_added", "date_modified", "language_id", "seo_keyword", "description", "meta_description", "meta_keywords", "meta_title", "store_ids", "layout", "status\nenabled");
    }
    ...
    protected function getProducts(&$database, $languageId) {
        ...
        $grand = array_merge($resultantArry[1], $resultantArry[2]);
