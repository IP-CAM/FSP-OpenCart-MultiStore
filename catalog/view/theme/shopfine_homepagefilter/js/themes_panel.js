jQuery(document).ready(function($){
	...
	jQuery('#layouts a').click(function() {
		...
		jQuery('#mainContainer').removeClass().addClass(layout_name);
	...
	if ($.cookie('layout') != null) {
		$.cookie('layout',$.cookie('layout'),{expires: 0});
		  jQuery('#mainContainer').removeClass('').addClass($.cookie('layout'));
	} else
	{
	  jQuery('#mainContainer').removeClass('').addClass('boxed');
	}
