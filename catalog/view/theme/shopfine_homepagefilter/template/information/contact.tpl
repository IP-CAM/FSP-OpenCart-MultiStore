...
<?php $googlemap_addr =  str_replace(" ","+",str_replace("<br />","+",str_replace("\n","+",$address))); ?>

        <div class="span8">
            <div class="google-map">
                <iframe height="246" src="https://maps.google.com/maps?q= <?php echo $googlemap_addr; ?>&amp;output=embed"></iframe>
            </div><!--end google-map-->
