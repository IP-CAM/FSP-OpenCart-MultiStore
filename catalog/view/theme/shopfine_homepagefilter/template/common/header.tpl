...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="<?php echo $lang; ?>"> <!--<![endif]-->
    ...
    <head>
        ...
        */  -->
        <link href="http://fonts.googleapis.com/css?family=Sanchez:400italic,400|Open+Sans:400italic,600italic,700italic,400,600" rel="stylesheet" />
        ...
        <!-- CSS ================================================== -->
        <link rel="stylesheet" href="catalog/view/theme/shopfine_homepagefilter/css/bootstrap.min.css" media="screen">
        <!-- jquery ui css -->
        <link rel="stylesheet" href="catalog/view/theme/shopfine_homepagefilter/css/jquery-ui-1.10.1.min.css">

        <link rel="stylesheet" href="catalog/view/theme/shopfine_homepagefilter/css/customize.css">
        <link rel="stylesheet" href="catalog/view/theme/shopfine_homepagefilter/css/font-awesome.css">
        <link rel="stylesheet" href="catalog/view/theme/shopfine_homepagefilter/css/style.css">
        <link rel="stylesheet" href="catalog/view/theme/shopfine_homepagefilter/css/backgrounds/flowers.css">

        <!-- flexslider css-->
        <link rel="stylesheet" href="catalog/view/theme/shopfine_homepagefilter/css/flexslider.css">

        <!-- bootstrap -->
        <script src="catalog/view/theme/shopfine_homepagefilter/js/bootstrap.min.js"></script>
        <!-- flexslider -->
        <script src="catalog/view/theme/shopfine_homepagefilter/js/jquery.flexslider-min.js"></script>
        <!-- cycle2 -->
        <script src="catalog/view/theme/shopfine_homepagefilter/js/jquery.cycle2.min.js"></script>
        <script src="catalog/view/theme/shopfine_homepagefilter/js/jquery.cycle2.carousel.min.js"></script>


        <!-- fancybox -->
        <link rel="stylesheet" href="catalog/view/theme/shopfine_homepagefilter/js/fancybox/jquery.fancybox.css">
        <script type="text/javascript" src="catalog/view/theme/shopfine_homepagefilter/js/fancybox/jquery.fancybox.js"></script>
        <script type="text/javascript" src="catalog/view/theme/shopfine_homepagefilter/js/fancybox/jquery.fancybox.pack.js"></script>
        ...
        <link rel="stylesheet" id="theme" type="text/css" href="catalog/view/theme/shopfine_homepagefilter/css/color/green.css" />
