...
<div style="clear: both;">
    <label for="shipping-address-existing">
        <input type="radio" name="shipping_address" value="existing" id="shipping-address-existing" style="float:left; margin-right: 4px;" checked="checked" /><?php echo $text_address_existing; ?>
    </label>
</div>
...
<div style="clear: both;">
  <label for="shipping-address-new">
        <input type="radio" name="shipping_address" value="new" style="float:left; margin-right: 4px;" id="shipping-address-new" /><?php echo $text_address_new; ?>
  </label>
</div>
<?php } ?>
