<div class="login">
  ...
  <?php } ?>
											...
											<button id="button-account" class="btn"><?php echo $button_continue; ?></button>
										</td>
										...
										<td>
											<h3><?php echo $text_returning_customer; ?></h3>
												...
												<div class="controls">
													<label>
									<a href="<?php echo $forgotten; ?>"><?php echo $text_forgotten; ?></a>			    </label>
												    <button id="button-login" type="submit" class="btn btn-primary"><?php echo $button_login; ?></button>
												</div>
											</form><!--end form-->
										</td>
									</tr>
