...
<?php } ?>
<div class="pay-info"><span style="float:left" class=""> <?php echo $text_sofort_msg;?></span></div>
<form action="<?php echo $action; ?>" method="POST"> 
    ...
    <input type="hidden" name="allowedMethods" value="directEbanking" />
    <input type="hidden" name="brandCode" value="directEbanking" />
