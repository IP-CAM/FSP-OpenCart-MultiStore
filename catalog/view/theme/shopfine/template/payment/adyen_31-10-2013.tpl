...
<div style="" class="radio credit-option">
    <input type="radio" id="adyen_radio" name="payment_radio" checked="checked">Creditcard<br/>
    ...
    <input type="radio" id="paypal_pro_radio" name="payment_radio"><span class="paypal-img"></span>
</div>

<div style="float:left;" class="credit-detail">
    <div id="adyen_mthod">
        <?php if ($testmode) { ?>
    ...
    <div id="paypal_pro" style="display:none; width:600px; "></div>
...
<script type="text/javascript">
    ...
    $('#paypal_pro_radio').live('click', function() {
    $('#adyen_mthod').attr("checked","");
    $('#adyen_mthod').hide();
    $('#paypal_pro').show();
...
$('#adyen_radio').live('click', function() {
$('#adyen_mthod').show();
$('#paypal_pro').hide();
