...
<script type="text/javascript">
    ...
    function checkallfields()
    {
               ...
               var msg = '';
                ...
                if(trim1(name)==''){
                    msg='<?php echo $error_holderName;?>';
                    nameObj.focus();
                }
                else if(trim1(number)==''){
                    msg='<?php echo $error_number;?>';
                    numberObj.focus();
                }
