        ...
        <form id="filterpro">
            ...
            <div class="price_slider" <?php if(!$price_slider) {echo 'style="display:none"';}?>>
                 <div class="price_slider_label">
                    ...
                    <input class="price_limit" type="text" name="min_price" value="-1" id="min_price"/>- <input class="price_limit" type="text" name="max_price" value="-1" id="max_price"/>
                </div>
                <!-- <br/>
                <table>
                    <tr>
        ...
        iF()
            ...
            <div class="option_box">
                ...
                <table class="collapsible">
                    ...
                    <td>
                        <span class="filtered option_value image-option" id="option_value_<?php echo $option_value['option_value_id']?>" >
                            <img src="http://<?php echo $_SERVER['HTTP_HOST'] ?>/newstore/image/<?php echo $option_value['image'] ?>" height="23"width="40" />
                ...
                <table class="collapsible">
                    <?php foreach($option['option_values'] as $option_value) { ?>
                    <td>
                        <span class="filtered option_value color-option" id="option_value_<?php echo $option_value['option_value_id']?>">
                            <img src="http://<?php echo $_SERVER['HTTP_HOST'] ?>/newstore/catalog/view/theme/shopfine/image/transparent-flr.png"  style="background-color: <?php echo $option_value['html'] ?>" />
                            <input type="hidden" disabled="true" name="option_value[<?php echo $option['option_id']?>][]"  value="<?php echo $option_value['option_value_id']?>" />
                        </span>
                    </td>
                    <?php } ?>
                ...
                <table class="collapsible months-option-table">
                    <?php foreach($option['option_values'] as $option_value) { ?>
                    <td>
                        <span class="filtered option_value months-option" id="option_value_<?php echo $option_value['option_value_id']?>">
                            <label for="option_value_<?php echo $option_value['option_value_id']?>"><?php echo $option_value['name']?></label>
                            <input type="hidden" disabled="true" name="option_value[<?php echo $option['option_id']?>][]"  value="<?php echo $option_value['option_value_id']?>" />
                        </span>
                    </td>
