            ...
            <div class="row">
                                    ...
                                    <div id="option-<?php echo $option['product_option_id']; ?>" class="product-info">
                                        ...
                                        <table class="dl-horizontal table-product-inputs">
                                            ...
                                            <tr>
                                                ...
                                                <?php if ($option_value['price']) { ?>
                                                <td><label style="margin-left: 10px;"><?php echo $option_value['price_prefix']; ?><?php echo $option_value['price']; ?></label></td>
                                                <?php } ?>
                                            </tr>
                                            <?php } ?>
                                        </table>
                ...
                <div class="span7 content-filter-options">
                    ...
                    <div class="text-filter-options">
                        ...
                        ?>
                        <span <?php echo $selected;?>><?php echo $dataOptions['name'][0]; ?></span>
                        <?php } ?>
                    </div>
                    <?php } ?>
