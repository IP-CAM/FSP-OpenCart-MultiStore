                                ...
                                <form>
                                    ...
                                    <div id="option-<?php echo $option['product_option_id']; ?>" class="product-info">
                                        ...
                                        <table class="dl-horizontal table-product-inputs">
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="radio" <?php if($countOp==1) { ?> style="display:none;  margin-left: -3px !importtant;"<?php } ?><?php if($k==0){ echo "checked='checked'";  }?>name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>" id="option-value-<?php echo $option_value['product_option_value_id']; ?>" />
                                                </td>
                                                <td>
                                                    <label <?php if($countOp==1) { ?> style="margin-left: -3px;"<?php } ?> for="option-value-<?php echo $option_value['product_option_value_id']; ?>"><?php echo $option_value['name']; ?></label>
                                                </td>
                                                <?php if ($option_value['price']) { ?>
