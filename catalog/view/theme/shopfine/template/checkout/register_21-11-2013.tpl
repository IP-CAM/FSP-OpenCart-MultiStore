<div class="left">
 ...
 <?php echo $entry_telephone; ?><br />
  ...
  <?php // echo $entry_fax; ?><br />
    <input type="text" name="fax" style="visibility: hidden" value="<?php echo $fax; ?>" class="large-field" />
  <br />
...
<div style="clear: both; padding-top: 15px; border-top: 1px solid #EEEEEE;">
  <label for="newsletter" ><input type="checkbox" name="newsletter" value="1" id="newsletter" style="float:left; margin-right: 4px;"/><?php echo $entry_newsletter; ?></label>
  <br />
  <?php if ($shipping_required) { ?>
  <label for="shipping" ><input type="checkbox" name="shipping_address" value="1" id="shipping" checked="checked" style="float:left; margin-right: 4px;" /><?php echo $entry_shipping; ?></label>
  <br />
  <?php } ?>
  <?php if ($text_agree) { ?>
  <label class="checkbox"><input type="checkbox" name="agree" value="1" style="float:left; margin-right: 4px;" /><?php echo $text_agree; ?></label>
<br>
  <?php } ?>
</div>
