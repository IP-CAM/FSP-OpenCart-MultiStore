...
<div style="clear: both;">
    <label for="payment-address-existing">
        <input type="radio" name="payment_address" value="existing" id="payment-address-existing" style="float:left; margin-right: 4px;" checked="checked" /><?php echo $text_address_existing; ?>
    </label>
</div>
...
<div style="clear: both;">
  <label for="payment-address-new">
      <input type="radio" name="payment_address" value="new" id="payment-address-new" style="float:left; margin-right: 4px;" /><?php echo $text_address_new; ?>
  </label>
</div>
<?php } ?>
<div id="payment-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
  <table class="form">
    ...
    <tr>
      <td><span id="payment-postcode-required" class="text-error">*</span> <?php echo $entry_postcode; ?></td>
