...
<div style="clear: both; padding-top: 15px; border-top: 1px solid #DDDDDD;">
  ...
  <input type="checkbox" name="shipping_address" value="1" id="shipping" checked="checked" style="float:left; margin-right:4px;" />
  <?php } else { ?>
  <input type="checkbox" name="shipping_address" value="1" id="shipping" style="float:left; margin-right:4px;" />
  <?php } ?>
  <label for="shipping" style="*display:inline"><?php echo $entry_shipping; ?></label>
  <br />
...
<div class="buttons clearfix" >
  <div class="right" >
    <input type="button" value="<?php echo $button_continue; ?>" id="button-guest" class="btn btn-primary"  style="*float:left; *margin-top:10px; *margin-left:-20px;"/>
  </div>
</div>
