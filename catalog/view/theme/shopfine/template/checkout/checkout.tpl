...
<div id="content">
    ...
    <div class="row">
        ...
        <div class="span12">
            ...
            <?php if($this->request->get['paymentResult'] == 'Refused- Invalid card number'){ ?>
                <div class="warning">Invalid card number</div>
            <?php }else{ ?>
            <div class="warning"><?php echo $text_checkout_payment_failed; ?></div>
            <?php } ?>
            <?php } ?>
...
<script type="text/javascript"><!--
    ...
    $('#checkout .checkout-content input[name=\'account\']').live('change', function() {
        if ($(this).attr('value') === 'register') {
            $('#payment-address .checkout-header h4').html('<?php echo $text_checkout_account; ?>');
        } else {
            $('#payment-address .checkout-header h4').html('<?php echo $text_checkout_payment_address; ?>');
        }
    });
        ...
        $.ajax({
            ...
            success: function(json) {
                ...
                if (json['redirect']) {
                    ...
                    $.ajax({
                        url: 'index.php?route=payment/get_all_paymentmethods',
                        dataType: 'html',
                        success: function(html) {
