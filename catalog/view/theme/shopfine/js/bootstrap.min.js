...
!function(e){
    ...
    t.prototype={
        ...
        sortObject:function(e){
            var t={},n;
            for(n in e)e[n].toLowerCase().indexOf(this.query.toLowerCase())||(t[n]=e[n],delete e[n]);for(n in e)~e[n].indexOf(this.query)&&(t[n]=e[n],delete e[n]);for(n in e)t[n]=e[n];return t
        },
    ...
    r.prototype={
        ...
        checkVal:function(e){
            ...
            for(var i=0,s=0;i<t;i++)if(this.tests[i]){
                ...
                if(s>n.length)break
            }else this.buffer[i]==n.charAt(s)&&i!=this.partialPosition&&(s++,r=i);if(!e&&r+1<this.partialPosition)this.$element.val(""),this.clearBuffer(0,t);
