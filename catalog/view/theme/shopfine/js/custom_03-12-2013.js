...
function dropdownMainNav() {
    ...
    navLis.hover(function() {
        ...
        if (!isNaN(ParentCat)) {
            ...
            if (CurrentChild.length) {
                CurrentChild.parent().children('div').not(".nav-children #mainNavChild_" + ParentCat).slideUp(0);
                CurrentChild.slideDown(0);
            } else {
    ...
    navMenu.hover(function() {
        $(".nav-children").children('div').not('#mainNavChild_' + ParentCatActive).slideUp(0);
        $('.nav-children #mainNavChild_' + ParentCatActive).slideDown(0);
    });
}
...
function showlist() {
    ...
    navLis.hover(
            function() {
                ...
                $(this).children('div ul').css('display', 'none');
                //show its submenu
            ...
            function() {
                ...
                //hide its submenu
                $(this).children('div ul').slideUp(50);
            }
    );
}
