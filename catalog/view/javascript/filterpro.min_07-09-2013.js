...
$(function () {
    $("#slider-range").slider({
        ...
        stop:function (a, b) {
            ...
            $("#min_price_label").html(b.values[0]);
            $("#max_price").val(b.values[1]);
            $("#max_price_label").html(b.values[1]);
    ...
    $("#min_price_label").html($("#slider-range").slider("values", 0));
    $("#max_price").val($("#slider-range").slider("values", 1));
    $("#max_price_label").html($("#slider-range").slider("values", 1));
});
