...
(function(){
    ...
    function RSAEncryptB64(bytes){
        var h=this.encrypt(bytes);
        if(h){
            return hex2b64(h)
        }else{
            return null
    ...
    sjcl.cipher.aes=function(a){
        this.g[0][0][0]||this.u();
        var b,c,d,e,f=this.g[0][4],g=this.g[1];
        b=a.length;
        var h=1;
        if(b!==4&&b!==6&&b!==8){
    ...
    sjcl.cipher.aes.prototype={
        ...
        g:[[[],[],[],[],[]],[[],[],[],[],[]]],
        u:function(){
            var a=this.g[0],b=this.g[1],c=a[4],d=b[4],e,f,g,h=[],i=[],k,j,l,m;
            for(e=0;e<256;e++){
    ...
    sjcl.bitArray={
        bitSlice:function(a,b,c){
            a=sjcl.bitArray.L(a.slice(b/32),32-(b&31)).slice(1);
        ...
        concat:function(a,b){
            ...
            return d===32?a.concat(b):sjcl.bitArray.L(b,d,c|0,a.slice(0,a.length-1))
        },
    ...
    sjcl.codec.base64={
        ...
        fromBits:function(a,b,c){
            var d="",e=0,f=sjcl.codec.base64.A,g=0,h=sjcl.bitArray.bitLength(a);
            if(c){
                f=f.substr(0,62)+"-_"
            }
        ...
        toBits:function(a,b){
            a=a.replace(/\s|=/g,"");
            var c=[],d=0,e=sjcl.codec.base64.A,f=0,g;
            if(b){
                e=e.substr(0,62)+"-_"
            }
    ...
    sjcl.hash.sha256.prototype={
        ...
        update:function(a){
            ...
            var b,c=this.h=sjcl.bitArray.concat(this.h,a);
            b=this.d;
            a=this.d=b+sjcl.bitArray.bitLength(a);
            for(b=512+b&-512;b<=a;b+=512){
                this.z(c.splice(0,16))
            }
            return this
        },
        finalize:function(){
            var a,b=this.h,c=this.l;
            b=sjcl.bitArray.concat(b,[sjcl.bitArray.partial(1,1)]);
            for(a=b.length+2;a&15;a++){
                b.push(0)
            }
            b.push(Math.floor(this.d/4294967296));
            for(b.push(this.d|0);b.length;){
                this.z(b.splice(0,16))
            }
            this.reset();
            return c
        },
        ...
        z:function(a){
            var b,c,d=a.slice(0),e=this.l,f=this.a,g=e[0],h=e[1],i=e[2],k=e[3],j=e[4],l=e[5],m=e[6],n=e[7];
            for(a=0;a<64;a++){
                if(a<16){
                    b=d[a]
                }else{
    ...
    sjcl.mode.ccm={
        ...
        decrypt:function(a,b,c,d,e){
            ...
            c=f.clamp(c,8*(15-b));
            i=sjcl.mode.ccm.F(a,i,c,k,e,b);
            a=sjcl.mode.ccm.C(a,i.data,c,d,e,b);
            if(!f.equal(i.tag,a)){
    ...
    sjcl.misc.hmac.prototype.encrypt=sjcl.misc.hmac.prototype.mac=function(a){
        a=(new this.I(this.j[0])).update(a).finalize();
        return(new this.I(this.j[1])).update(a).finalize()
    };
    ...
    sjcl.random={
        ...
        addEntropy:function(a,b,c){
            c=c||"user";
            var d,e,f=(new Date).valueOf(),g=this.o[c],h=this.isReady(),i=0;
            d=this.B[c];
            if(d===undefined){
                d=this.B[c]=this.O++
            }
            ...
            this.o[c]=(this.o[c]+1)%this.b.length;
            switch(typeof a){
                case"number":
                    if(b===undefined){
                        b=1
                    }
                    this.b[g].update([d,this.s++,1,b,f,1,a|0]);
                    break;
                case"object":
                    ...
                    if(!i){
                        ...
                        this.b[g].update([d,this.s++,2,b,f,a.length].concat(a))
                    }
                    break;
                case"string":
                    if(b===undefined){
                    ...
                    this.b[g].update([d,this.s++,3,b,f,a.length]);
                    this.b[g].update(a);
                    break;
                default:
                    i=1
            ...
            this.e+=b;
            if(h===0){
                this.isReady()!==0&&this.G("seeded",Math.max(this.f,this.e));
                this.G("progress",this.getProgress())
            }
        },
        isReady:function(a){
            a=this.w[a!==undefined?a:this.r];
            return this.f&&this.f>=a?this.i[0]>80&&(new Date).valueOf()>this.K?3:1:this.e>=a?2:0
        },
        getProgress:function(a){
            a=this.w[a?a:this.r];
            return this.f>=a?1:this.e>a?1:this.e/a
        },
        startCollectors:function(){
            if(!this.k){
                if(window.addEventListener){
                    window.addEventListener("load",this.m,false);
                    window.addEventListener("mousemove",this.n,false)
                }else{
                    if(document.attachEvent){
                        document.attachEvent("onload",this.m);
                        document.attachEvent("onmousemove",this.n)
                    }else{
        ...
        stopCollectors:function(){
            if(this.k){
                if(window.removeEventListener){
                    window.removeEventListener("load",this.m,false);
                    window.removeEventListener("mousemove",this.n,false)
                }else{
                    if(window.detachEvent){
                        window.detachEvent("onload",this.m);
                        window.detachEvent("onmousemove",this.n)
                    }
                }
                this.k=false
            }
        ...
        N:0,
        w:[0,48,64,96,128,192,256,384,512,768,1024],
        t:function(){
            for(var a=0;a<4;a++){
                this.c[a]=this.c[a]+1|0;
                if(this.c[a]){
                    break
                }
            }
            return this.q.encrypt(this.c)
        },
        H:function(){
            this.a=this.t().concat(this.t());
            this.q=new sjcl.cipher.aes(this.a)
        },
        P:function(a){
        ...
        Q:function(a){
            var b=[],c=0,d;
            this.K=b[0]=(new Date).valueOf()+30000;
            for(d=0;d<16;d++){
    ...
    EncryptedForm.prototype={
        ...
        getEncryptedFields:function(node,fields){
            ...
            for(var i=0;i<children.length;i++){
                child=children[i];
                if(child.getAttribute("data-encrypted-name")){
                    fields.push(child)
                }else{
