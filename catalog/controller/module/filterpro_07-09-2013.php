...
class ControllerModuleFilterPro extends Controller {
    ...
    public function getProducts() {
        ...
        $currencySymbol = $this->currency->getSymbolLeft($this->config->get('config_currency'));
        ...
        $json = json_encode(array('result' => $result, 'currencySymbol' => $currencySymbol, 'min_price' => $min_price, 'max_price' => $max_price, 'total_show' => $totalproduct_to_show_html, 'pagination' => $pagination->render() . $totalproduct_to_show_html,
