<?php  
class ControllerModuleShopfineSlideshow extends Controller {
	protected function index($setting) {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/shopfine_slideshow.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/module/shopfine_slideshow.tpl';
		} else {
			$this->template = 'default/template/module/shopfine_slideshow.tpl';
		}
