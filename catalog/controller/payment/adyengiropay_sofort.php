...
class ControllerPaymentAdyenGiropaySofort extends Controller {
    ...
    public function index() {
        ...
        $this->data['button_confirm'] = $this->language->get('text_button_sofort');
        $this->data['text_sofort_msg'] = $this->language->get('text_sofort_msg');
        $this->data['testmode'] = $this->config->get('adyen_sofort_test');
        ...
        $this->data['shipBeforeDate'] = $this->config->get('adyen_sofort_days_till_delivery');
        $this->data['session_valid_till'] = 1;
        $this->data['session_valid_till'] = $this->config->get('adyen_sofort_session_valid_till');
        ...
        if (!$this->config->get('adyen_sofort_test')) {
            $this->data['action'] = 'https://live.adyen.com/hpp/details.shtml';
            $sharedSecret = $this->config->get('adyen_sofort_hmac_live');
        } else {
            $this->data['action'] = 'https://test.adyen.com/hpp/details.shtml';
            $sharedSecret = $this->config->get('adyen_sofort_hmac_test');
        }
        ...
        if ($order_info) {
            ...
            //Adyen Fields
            $this->data['merchantAccount'] = $this->config->get('adyen_sofort_email');
            $this->data['skinCode'] = $this->config->get('adyen_sofort_skincode');
            ...
            $this->data['return'] = $this->url->link('payment/adyen_sofort/callback');
...
//            $this->data['cancel_return'] = $this->url->link('payment/adyen/adyenCallback', '', 'SSL');
            ...
            $sign = $this->data['totalAmount'] . $this->data['currency_code'] . $this->data['shipBeforeDate'] . $this->data['merchantReference'] . $this->data['skinCode'] . $this->data['merchantAccount']
                    . $this->data['sessionValidity'] . $this->data['email'] . 'directEbanking' . $this->session->data['order_id'];
